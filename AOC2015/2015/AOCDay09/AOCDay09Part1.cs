...
namespace AOC2015
{
    public class AOCDay09Part1 : AOCProblem
    {
        public AOCDay09Part1(String[] input, IStandardMessages standardMessages) : base(input, standardMessages) { }        
        ...
        protected override String DoSolve(String[] input)
        {
            ...
            Int32 shortestPath = pathCollection.ShortestDistance();

            return $"The Shortest Route is { shortestPath }.";            
        }
