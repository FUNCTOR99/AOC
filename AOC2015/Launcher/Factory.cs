        ...
        public static AOCProblem CreateProblem(Int32 day, Int32 part, InputType inputType)
        {
            ...
            switch (day)
            {
                ...
                case 202018:
                    ...
                    {
                        case 1:
                            IInput inputp1 = CreateInput(inputType, "Inputs/2020_d18p01_input.txt");
                            return new AOC2020Day18Part1(inputp1.GetInput(), standardMessages);

                        case 2:
                            IInput inputp2 = CreateInput(inputType, "Inputs/2020_d18p01_input.txt");
                            return new AOC2020Day18Part2(inputp2.GetInput(), standardMessages);
                    }
                    break;
                ...
                case 202019:
                    switch (part)
                    {
                        ...
                        case 2:
                            IInput inputp2 = CreateInput(inputType, "Inputs/2020_d19p01_input.txt");
                            return new AOC2020Day19Part2(inputp2.GetInput(), standardMessages);
                    }
                    break;
                ...
                case 202020:
                    ...
                    {
                        case 1:
                            IInput inputp1 = CreateInput(inputType, "Inputs/2020_d20p01_input.txt");
                            return new AOC2020Day20Part1(inputp1.GetInput(), standardMessages);

                        case 2:
                            IInput inputp2 = CreateInput(inputType, "Inputs/2020_d20p01_input.txt");
                            return new AOC2020Day20Part2(inputp2.GetInput(), standardMessages);
                    }
                    break;
                ...
                case 202021:
                    ...
                    {
                        case 1:
                            IInput inputp1 = CreateInput(inputType, "Inputs/2020_d21p01_input.txt");
                            return new AOC2020Day21Part1(inputp1.GetInput(), standardMessages);

                        case 2:
                            IInput inputp2 = CreateInput(inputType, "Inputs/2020_d21p01_input.txt");
                            return new AOC2020Day21Part2(inputp2.GetInput(), standardMessages);
                    }
                    break;
                ...
                case 202022:
                    ...
                    {
                        case 1:
                            IInput inputp1 = CreateInput(inputType, "Inputs/2020_d22p01_input.txt");
                            return new AOC2020Day22Part1(inputp1.GetInput(), standardMessages);

                        case 2:
                            IInput inputp2 = CreateInput(inputType, "Inputs/2020_d22p01_input.txt");
                            return new AOC2020Day22Part2(inputp2.GetInput(), standardMessages);
                    }
                    break;                
                ...
                case 202024:
                    ...
                    {
                        case 1:
                            IInput inputp1 = CreateInput(inputType, "Inputs/2020_d24p01_input.txt");
                            return new AOC2020Day24Part1(inputp1.GetInput(), standardMessages);

                        case 2:
                            IInput inputp2 = CreateInput(inputType, "Inputs/2020_d24p02_input.txt");
                            return new AOC2020Day24Part2(inputp2.GetInput(), standardMessages);
                    }
                    break;
                ...
                case 202023:
                    ...
                    {
                        case 1:
                            IInput inputp1 = CreateInput(inputType, "Inputs/2020_d23p01_input.txt");
                ...
                case 202025:
                    ...
                    {
                        case 1:
                            IInput inputp1 = CreateInput(inputType, "Inputs/2020_d25p01_input.txt");
                            return new AOC2020Day25Part1(inputp1.GetInput(), standardMessages);

                        case 2:
                            IInput inputp2 = CreateInput(inputType, "Inputs/2020_d25p01_input.txt");
                            return new AOC2020Day25Part2(inputp2.GetInput(), standardMessages);
                    }
                    break;
