...
namespace AOC2015
{
    ...
    {
        public LogicGateOR(ref IWire inputWire1, ref IWire inputWire2, ref IWire outputWire) : base(ref inputWire1, ref inputWire2, ref outputWire) 
        {
            LogicGateType = LogicGateType.Or;
        }
