...
namespace AOC2015
{
    public class AOCDay17Part1 : AOCProblem
    {
        public AOCDay17Part1(String[] input, IStandardMessages standardMessages) : base(input, standardMessages) { }        
        ...
        protected override String DoSolve(String[] input)
        {
            ...
            return $"There are {containersThatSumToVolume.Count()} combinations that sum to {totalVolume} liters.";            
        }  
